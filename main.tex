...
\begin{titlepage}
  ...
  {\normalsize Inspired by concepts originally created by Ethanol, the creator of Cursed Catan.\par}
...
\begin{itemize}[leftmargin=1.2cm]
  \item Coal is represented by standard Monopoly houses (or any singular building piece from any board game).
...
\begin{warningbox}
  If a player desires to be the sole victor of the war, they may declare a \textbf{Defection} against their current faction. Upon doing so they immediately become an Independent Faction. As an Independent Faction the player is no longer bound by faction cooperation rules and may pursue an individual victory under the stated victory conditions.
\end{warningbox}
